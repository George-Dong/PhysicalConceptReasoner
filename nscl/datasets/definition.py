...
class DatasetDefinitionBase(object):
    parameter_types = ['concept', 'relational_concept', 'attribute', 'temporal_concept', 'time_concept', 'spatial_concept', 'mass_concept', 'charge_concept', 'physical_concept']
